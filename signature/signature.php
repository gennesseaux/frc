 ...
 *   		- le nombre d'XP
 *   		- le kill death ratio
 *   		- les trois classes les plus utilis√©es
 *   		- les deux v√©hicules les plus utilis√©q
 *   		- le meilleur score de la premi√®re classe
 *   		- le meilleur score du premier v√©hicule
 * 
 ...
 */
 ...
 <?php
	...
	// CrÈation d'un fond blanc comme image principale
	...
	//On prepare les couleurs, en RGB pour la police d'Ècriture
	$blanc = imagecolorallocate($fond, 255, 255, 255);
	$noir = imagecolorallocate($image, 0, 0, 0);
	
	// Police TTF utilisÈÈe pour l'Ècriture dans l'image
	...
	// Identifiant de l'outfit FRC : il faut Ítre membre de la FRC pour que la signature fonctionne
	...
	if(isset($_GET["pseudo"]) && isset($_GET["id"])==false) 
	{
		...
		// IntÈrogation de l'API de planetside 2
	...
	// Il faut Ítre membre de la FRC pour que les informations s'affichent
	if($UserId>0 && $outfit && $outfit->id==$FrcId) 
	{
		...
		// Scores et temps de jeux par vÈhicule
		...
		// Ajout des icones pour les classes les plus jouÈes
		// ----------------------------------------------------------------
		// Supprime les derniers ÈlËments afin de ne garder que les 3 premiers
		...
		// Ajout des icones pour les vÈhicules les plus jouÈes
		// ----------------------------------------------------------------
		// Supprime les derniers ÈlËments afin de ne garder que les 2 premiers
		...
		// ----------------------------------------------------------------
		// Supprime les derniers ÈlËments afin de ne garder que le premier
		...
		// Ajout des icones pour les vÈhicules ayant le meilleur score
		// ----------------------------------------------------------------
		// Supprime les derniers ÈlËments afin de ne garder que le premier
	...
	// on spÈcifie que le type de document que l'on va crÈer est une image png
...
<?php 
/*
 * VÈhicule en fonctuion de son id
 */
