<?php
	...
	if($UserId>0 && $outfit && $outfit->id==$FrcId) 
	{
		...
		// Scores et temps de jeux par véhicule
		...
		// ----------------------------------------------------------------
		// Supprime les derniers élèments afin de ne garder que les 2 premiers
		...
		// ----------------------------------------------------------------
		// Supprime les derniers élèments afin de ne garder que le premier
		...
		// Ajout des icones pour les véhicules ayant le meilleur score
		// ----------------------------------------------------------------
		// Supprime les derniers élèments afin de ne garder que le premier
...
<?php 
/*
 * Véhicule en fonctuion de son id
 */
